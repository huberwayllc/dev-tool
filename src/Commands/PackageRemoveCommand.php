...
namespace HuberwayCMS\DevTool\Commands;
...
class PackageRemoveCommand extends Command implements PromptsForMissingInput
{
    ...
    protected function processRemove(string $package, string $location): bool
    {
        ...
        $this->components->info('Remove <comment>"huberwaycms/' . $package . '": "*@dev"</comment> to composer.json then run <comment>composer update</comment> to remove this package!');
